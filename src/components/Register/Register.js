    ...
    <div className="container my-5">
      <div className="row">
        <div className="col-12 col-md-9 col-lg-6 border border-info rounded p-5 mx-auto">
          <p className="text-info display-5 text-center">Register</p>
          <form onSubmit={handleRegistration}>
            ...
            <p className="my-3">
              ...
              <Link className="text-decoration-none text-color" to="/login">
                <li className="btn btn-outline-info">Login</li>
              </Link>
            </p>
            <hr />
            <p className="fs-5 btn btn-outline-info" onClick={handleGoogleRegister}>
